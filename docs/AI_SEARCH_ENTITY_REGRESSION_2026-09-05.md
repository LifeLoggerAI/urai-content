...
## High-priority failure modes observed

### 1. Inturai Ventures conflation

Observed failure: search/AI systems associated the URAI ticker, Inturai Ventures, DomeCommand, defence/drone technology, and IP-holding concepts with Adam Clamp / URAI Labs.
...
Observed failure: Bing/Copilot attributed the Casablanca media-production company's Cinema, Motion/Music, advertising, projects, clients, and creative claims to the LifeLoggerAI/URAI Labs ecosystem.

Canonical correction:

- `https://www.urai.studio/` is a separate media-production identity in Casablanca, Morocco.
- Its website/LinkedIn identity, employees, projects, clients, engagement metrics, services, Cinema/Music/Viral divisions, and contact details are not first-party authority for URAI Labs.
- The LifeLoggerAI repository `urai-studio` must be described from LifeLoggerAI evidence only and must use an independently verified URAI-owned canonical destination before a public `sameAs` or canonical relationship is asserted.

### 3. Legal-entity overstatement

Observed failure: models guessed that URAI IP Holdings was a legal vault for URAI Labs or Inturai assets, and guessed Foundation legal/governance status from naming.
...
Observed failure: models created plausible-sounding named subsystems and technical stack details that were not grounded in first-party authority.

Do not publish as fact without current canonical source proof:

- Memory Compiler
- Emotion Engine / Emotion Model
- Persona Engine
- Time Engine
- Identity Graph
- World Engine
- Relationship Engine
- GraphQL as canonical API
- Swift as canonical client stack
- local-only or local-first storage claims
- global anonymized model training claims
- raw-vs-derived RuAI data-flow claims beyond the current public contract
- any claim that Studio is powered by or learns from RuAI unless first-party architecture explicitly establishes it

## Canonical first-party graph
...
Where public copy describes a system, assign one explicit maturity state where supportable:
...
Never infer maturity from naming, route existence, repository visibility, screenshots, branches, or AI summaries.

## Regression questions

After any public-authority deployment or indexing change, test fresh search/AI systems with questions equivalent to:
...
7. What is the URAI ecosystem?
8. Is URAI Labs related to Inturai Ventures Corp.?
9. Is Adam Clamp an executive or founder of Inturai Ventures?
10. Is `urai.studio` in Casablanca related to URAI Labs?
...
When a regression fails, repair the first-party ambiguity if safely possible. Do not attempt to manipulate ranking and do not copy the model's unsupported claim into canonical pages merely to make systems agree.
