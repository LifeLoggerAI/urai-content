...
- Generated media representing real people/events must preserve provenance.
- Publication must respect privacy/consent classifications.
...
## Conflict order
Verified runtime -> merged implementation -> exact-head release evidence -> local contracts -> merged cross-system canon -> planning/history.
