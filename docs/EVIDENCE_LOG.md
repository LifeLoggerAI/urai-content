...
Head verified: `5148bae3c286517b3d365e2a44a54de69ae0ebf8`
PR: #45
...
| --- | --- | --- |
| Export lifecycle test repair | Implemented | `tests/exports.test.ts` now creates its own completed export fixture through `startExportJob()` and `completeExportJob()` instead of relying on fake completed seed proof. |
